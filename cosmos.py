...
# Create the tables
cursor.execute("CREATE TABLE course (pid VARCHAR(30) PRIMARY KEY, slug VARCHAR(200) UNIQUE, program_id VARCHAR(10),\
                course_number VARCHAR(100), title VARCHAR(200), credit VARCHAR(100), hours VARCHAR(100), description VARCHAR(15000),\
                notes VARCHAR(10000), link VARCHAR(200));")
cursor.execute("CREATE TABLE degree (code VARCHAR(100) PRIMARY KEY, cred VARCHAR(100), program_id VARCHAR(10),\
                description VARCHAR(10000), link VARCHAR(200), requirements VARCHAR(50000), notes VARCHAR(10000));")
cursor.execute("CREATE TABLE meetinglocation (slug VARCHAR(200) PRIMARY KEY, building VARCHAR(100), room VARCHAR(10));")
cursor.execute("CREATE TABLE meetingtime (slug VARCHAR(200) PRIMARY KEY, term VARCHAR(6), start_time VARCHAR(6), end_time VARCHAR(6), \
